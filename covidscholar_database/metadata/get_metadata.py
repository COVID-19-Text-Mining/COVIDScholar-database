...
parser_folder = os.path.join(parent_folder, 'parse')
...
from covidscholar_database.metadata.parser_crossref import CrossrefParser
from covidscholar_database.metadata.parser_scopus import ScopusParser
...
if __name__ == '__main__':
    ...
    doc = get_metadata_by_doi(db, doi='10.1016/B978-0-12-385034-8.00005-3')
